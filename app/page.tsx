...
export default function Home() {
  return (
    <div style={{ minHeight: '100vh', background: '#fff', fontFamily: 'sans-serif' }}>
      ...
      {/* ヒーロー */}
      <div style={{ background: 'linear-gradient(135deg, #f0f0ff 0%, #fff7ed 50%, #f0fdf4 100%)', padding: '80px 24px 60px' }}>
      ...
      {/* 特徴 */}
      <div style={{ maxWidth: '900px', margin: '80px auto 0', padding: '0 24px 80px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', maxWidth: '600px', margin: '0 auto 60px' }}>
          {[
        ...
        {/* CTA */}
        <div style={{ background: 'linear-gradient(135deg, #111 0%, #333 100%)', borderRadius: '24px', padding: '48px', textAlign: 'center', color: '#fff' }}>
          <h2 style={{ fontSize: '28px', fontWeight: '700', marginBottom: '12px', letterSpacing: '-1px' }}>今すぐ無料で始めよう</h2>
          <p style={{ fontSize: '14px', opacity: 0.6, marginBottom: '28px' }}>夏コミまでに使いこなせるように、今から準備しよう</p>
